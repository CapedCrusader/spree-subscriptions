def create_variants_for(product)
  ...
  variant1 = create(:variant, :product => product, :num_subscription_units => 12, :option_values => [annual_option_value])
  variant2 = create(:variant, :product => product, :num_subscription_units => 24, :option_values => [biennal_option_value])
  [variant1, variant2]
end
